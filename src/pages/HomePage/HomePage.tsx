      ...
      <div className="flex">
        ...
        <div className="w-full sm:w-4/12 lg:w-2/12  px-2">
          <Button
            ...
            className="shadow-md hover:shadow-lg flex items-center justify-center w-full text-white search-button py-2 px-2 rounded-md outline-none focus:outline-none">
            Select All Files
          </Button>
        </div>
      </div>
